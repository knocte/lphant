...
;
; *** Inno Setup version 4.1.4+ Mensajes en Español ***
;
...
;
; $Id: Default.isl,v 1.24 2004/02/09 04:20:57 jr Exp $
...
SelectLanguageLabel=Seleccione el idioma quedesea usar durante la instalación:
...
SelectDirLabel3=Instalar instalará [name] en la siguiente carpeta.
SelectDirBrowseLabel=Para continuar, haga click en Siguiente. Si Ud. prefiere otra carpeta, haga click en Examinar
...
SelectStartMenuFolderLabel3=Instalar creará los accesos directos al programa en la carpeta Programas.
SelectStartMenuFolderBrowseLabel=Para continuar, haga click en Siguiente. Si Ud. prefiere otra carpeta, haga click en Examinar.
NoIconsCheck=&No crear icono
MustEnterGroupName=Debe proporcionar el nombre de la carpeta.
GroupNameTooLong=El nombre de la carpeta o la ruta es demasido grande.
...
ErrorRegisterServer=Imposible registrar librería DLL/OCX: %1
...
OnlyAdminCanUninstall=Este programa sólo puede ser eliminado por un usuario con privilegios administrativos.
